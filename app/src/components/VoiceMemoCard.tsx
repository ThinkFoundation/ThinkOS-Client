...
interface VoiceMemo {
  id: number;
  type: "voice_memo" | "voice"; // "voice" for backwards compat
  title: string;
  summary: string | null;
  tags: MemoryTag[];
  created_at: string;
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3 p-2.5 rounded-lg bg-slate-100/50 dark:bg-white/5">
        <Button
          ...
          className="h-9 w-9 rounded-full bg-orange-100 hover:bg-orange-200 dark:bg-orange-900/30 dark:hover:bg-orange-900/50 text-orange-600"
        >
          {isLoading ? (
